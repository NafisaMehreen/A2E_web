        ...
        <section className="py-20 bg-gray-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center">
                    <Link to="/blog" className="text-white px-8 py-4 rounded-full text-lg transition-all duration-300 hover:scale-105 comfortaa-medium inline-flex items-center group" style={{ backgroundColor: '#0a528e' }}>
                        View More Stories 
